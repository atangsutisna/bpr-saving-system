...
<div class="row">
    <div class="col-12">
        <div class="card card-warning">
            ...
            <div class="card-body">
                <p>Selamat bergabung {{ auth()->user()->name}},</p>
                <p>Akun anda sudah aktif, namun ada beberapa yang perlu dilengkapi, silakan lengkapi <a href="{{ url('admin/profile') }}">di sini</a>.</p>
            </div>
        </div>
    </div>
</div>
...
@if (auth()->user()->review_status == 1 && auth()->user()->code_verification == 0)
<div class="row">
    <div class="col-12">
        <div class="card card-warning">
            <div class="card-header">
            ...
            <div class="card-body">
                ...
                <p>Akun anda sudah direview, kami telah mengirimkan kode ke email Anda. <br/>
                Silahkan lakukan verifikasi dengan memasukan kode tersebut <a href="{{ url('admin/profile') }}">di sini</a>.</p>
            </div>
        </div>
    </div>
</div>
